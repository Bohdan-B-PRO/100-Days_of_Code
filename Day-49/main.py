...
driver.get("My_current_acount for example: https://www.linkedin.com/jobs/search/?f_AL=true&geoId=101174742&keywords=Analytic%20Recruiting%20Inc&location=Canada")
...
# Scan available jobs
jobs = driver.find_element(by=By.CLASS_NAME, value='job-card-list__title')
